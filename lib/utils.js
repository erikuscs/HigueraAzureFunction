...
// Removed ApplicationInsightsClient import as we're using the applicationinsights package instead
const appInsightsEnabled = !!process.env.APPLICATIONINSIGHTS_CONNECTION_STRING;
...
function formatDashboardData(data) {
  try {
    ...
    trackException(error, { operation: 'formatDashboardData' });
